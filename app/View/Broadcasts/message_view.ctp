...
<table class="table table-striped table-hover">
	...
	?>
		<tr class="hand" onclick="message_detail(<?php echo $sms_id; ?>)">
			...
			<a href="#" class="btn mini black popovers pull-right" data-trigger="hover" data-placement="left" data-content="<b>Generated By: </b><?php echo $name; ?> <br/><b>Generated On: </b><?php echo $date; ?><br/>"role="button" data-original-title=""><i class="icon-exclamation-sign"></i></a>
			</td>
		</tr>
	<?php } ?>
	</tbody>
