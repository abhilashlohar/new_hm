...
<td class="hide_at_print" style="width:8%;"> 
...
<li><a href="journal_voucher_edit/<?php echo $voucher_id; ?>" target="_blank" ><i class="icon-pencil"></i> Edit</a>  </li>
<li><a href="journal_voucher_pdf/<?php echo $voucher_id; ?>" target="_blank"><i class="icon-file"></i>Pdf</a></li>

</ul>
</div> 

<a href="#" class="btn mini black popovers" data-trigger="hover" data-placement="left" data-content="<b>Generated By: </b><?php echo $prepaired_by ?><br/><b>Generated On: </b><?php echo $current_date ?>" role="button"><i class="icon-exclamation-sign"></i></a>
