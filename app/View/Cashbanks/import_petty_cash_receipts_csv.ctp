...
<div class="portlet box green" style="width: 50%; margin: auto;">
	<div class="portlet-title">
		<h4><i class="icon-cogs"></i> Import Petty Cash Receipts</h4>
	</div>
	<div class="portlet-body" align="">
		<form method="post" id="form1" style="margin: 0px;">
			...
			<a href="<?php echo $webroot_path; ?>Cashbanks/petty_cash_receipt_sample"><b>Click here for sample format</b></a><br/><br/>
...
$( document ).ready(function() {
    $.ajax({
		url: "petty_cash_read_csv_file",
		dataType: 'json'
	}).done(function(response){
		
		if(response=="READ"){
			change_page_automatically("<?php echo $webroot_path; ?>Cashbanks/import_petty_cash_receipts_csv");
		}
	});
});
</script>
...
$('form#form1').submit( function(ev){
	...
	if(allow=="yes"){
		...
		$.ajax({
		url: "Upload_petty_cash_receipt_csv_file",
		data: m_data,
		processData: false,
		contentType: false,
		type: 'POST',
