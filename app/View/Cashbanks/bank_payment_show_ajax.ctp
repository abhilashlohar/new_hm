...
<tr>
	...
	<td style="text-align:right;"><?php echo $total_tds_amount; ?> <span style="display:none;"><?php echo $total_new; ?></span></td>
	...
	<a href="#" class="btn mini black popovers" data-trigger="hover" data-placement="left" data-content="<b>Generated By: </b><?php echo $creater_name ?><br/><b>Generated On: </b><?php echo $creation_date ?><?php echo @$edit_info; ?>" role="button"><i class="icon-exclamation-sign"></i></a>
