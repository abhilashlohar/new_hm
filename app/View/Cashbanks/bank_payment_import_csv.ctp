...
<div class="portlet box green" style="width: 50%; margin: auto;">
	...
	<div class="portlet-body" align="">
		<form method="post" id="form1" style="margin: 0px;">
			...
			<a href="bank_payment_import_excel" download=""><b>Click here for sample format</b></a><br/>
			<div id="vali"></div>
			<br/>
	...
	$( document ).ready(function() {
		$.ajax({
			...
			if(response.again_call_ajax=="NO"){
				...
				$("#first_div").html('<div class="alert alert-block alert-success fade in"><h4 class="alert-heading">Success!</h4><p>Vouchers Imported successfully.</p><p><a class="btn green" href="<?php echo $webroot_path; ?>Cashbanks/bank_payment_import_csv" >OK</a> </p></div>');
			}
		});
	});
}
