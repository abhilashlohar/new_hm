	...
	@$dattt = date('d-m-Y',strtotime(@$date));			
			...
			<?php if($table_name=="fix_asset"){
				echo $refrence_no;
						...
						<td style="text-align:right;"><?php echo $this->Currency->formatCurrency( $debit, "INR");  $total_debit+=$debit; ?></td>
						<td style="text-align:right;"><?php echo $this->Currency->formatCurrency( $credit, "INR"); $total_credit+=$credit; ?></td>
			...
			<?php } ?>
					...
					<tr>
						...
						<td style="text-align:right;"><b><?php echo $this->Currency->formatCurrency( $total_debit, "INR"); ?></b></td>
						<td style="text-align:right;"><b><?php echo $this->Currency->formatCurrency( $total_credit, "INR"); ?></b></td>
