...
<a href="#" class="btn mini black popovers" data-trigger="hover" data-placement="left" data-content="<b>Generated By: </b><?php echo $prepaired_by_name ?><br/><b>Generated On: </b><?php echo $creation_date ?>" role="button"><i class="icon-exclamation-sign"></i></a>
