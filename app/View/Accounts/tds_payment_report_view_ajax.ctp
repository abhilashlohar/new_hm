...
<div style="width:100%; overflow:auto; margin-top:10px;" class="hide_at_print">
	<label class="m-wrap pull-right"><input type="text" id="search" class="m-wrap medium" style="background-color:#FFF !important;" placeholder="Search">
	</label>	
</div>	
<table  width="100%" style="background-color:white;" class="table table-bordered table-striped table-hover">
	<thead>
		<tr>
			...
			<?php echo $society_name; ?> TDS Payment Report Register From : <?php echo $from; ?> &nbsp;&nbsp; To : <?php echo $to; ?>
			</th>
			</tr>
			<tr>
