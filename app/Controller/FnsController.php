...
function calculate_arrears_and_interest_bill_date($ledger_sub_account_id,$start_date){
	$s_society_id=$this->Session->read('hm_society_id');
...
function calculate_arrears_and_interest_edit_bill_date($ledger_sub_account_id,$start_date){
	$s_society_id=$this->Session->read('hm_society_id');
	...
	if($bill_count==0){
		...
		$last_bill_start_date=$last_bill_info[0]["regular_bill"]["start_date"];
		$bill_date=$last_bill_start_date;
...
function calculate_arrears_and_interest_edit123($ledger_sub_account_id,$start_date){
	$s_society_id=$this->Session->read('hm_society_id');
...
function calculate_opening_balance_for_ledger($ledger_account_id=null,$ledger_sub_account_id=null,$date=null){
	$s_society_id = (int)$this->Session->read('hm_society_id');	
	...
	if($accounts_id==1 or $accounts_id==2){ 
		...
		$last_bill_start_year= date("Y",$last_bill_start_date);
		$last_bill_end_year= date("Y",$last_bill_end);
		$first_date=$last_bill_start_date;
