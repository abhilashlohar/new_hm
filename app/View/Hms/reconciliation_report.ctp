...
<div align="center" class="mobile-align">
	...
	<a href="reconciliation_report"  rel='tab' class="btn red  tooltips space-responsive" ><i class="icon-folder-close"></i> Reconciliation Report</a>
</div>
...
$(document).ready(function() {
	    ...
	    $("#go").bind('click',function(){
			...
			var from=$('#date1').val();
		    var to=$('#date2').val();
			$("#ledger_view").html('<div align="center" style="padding:10px;"><img src="<?php echo $webroot_path; ?>as/loding.gif" />Loading....</div>').load("reconciliation_report_ajax/" +ledger_account_id+ "/" +from+ "/" +to+"");
	});
});
</script>