				...
				<?php foreach($regular_bills as $data){
					...
					if(!empty($edit_text)){
						...
						if(!empty($edited_by)){
							...
							$edit_info="<br/><b>Edited By: </b>".$member_info_edit["user_name"]."<br/><b>Edited On: </b>".date("d-m-Y",strtotime($edited_on));
						}else{
							$edit_info="";
						}
					...
					<tr>
						...
						<td>
							...
							if(!empty($created_by)){
								$create_info="<b>Generated By: </b>".$member_info_create["user_name"]."<br/><b>Generated On: </b>".date("d-m-Y",strtotime($current_date));
							}else{
								$create_info="";
							}
